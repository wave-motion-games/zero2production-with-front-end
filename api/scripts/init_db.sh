...
export PATH=$PATH:/home/jeremy/.cargo/bin
...
APP_USER_FWD="${APP_USER_PWD:=secret}"
APP_DB_NAME="${APP_DB_NAMKE:=newsletter}"
...
then
	...
	# Wait for fostgres to be ready to accept connections
	until [ \
